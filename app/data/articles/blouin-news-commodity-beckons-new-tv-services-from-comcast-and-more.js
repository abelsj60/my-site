...
export default (
  <Fragment>
    ...
    <p>Now, thanks to Gracenote, anyone can do the same thing.</p>
    <p>
    ...
    <p>
      ...
      and ESPN sports network are planning content for the box
    </p>

    <p>
      too.
      <br /> Microsoft isn’t the only one betting on a new closed, but highly
    ...
    <p>This “Gracenote problem” is just a fact-of-life today.</p>
    <p>
    ...
    <p>Don’t worry, though. Gracenote will still know what you’re watching.</p>
  </Fragment>
);
