...
export default (
  <Fragment>
    ...
    <p>How has that played out for your businesses this year?</p>
    <p>
    ...
    <p>What does the goal for three-year-old Mansueto Ventures become then?</p>
    <p>
      Our goal is to increase market share when times are difficult, so I think
      as long as we're showing progress we'll be OK.
    </p>
    <p>Combining print with digital will help you with that? Why?</p>
    <p>
    ...
    <p>And that will help you grow revenues through a recession?</p>
    <p>
