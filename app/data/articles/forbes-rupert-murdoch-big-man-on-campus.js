...
export default (
  <Fragment>
    <p>Heading back to college this fall? Rupert Murdoch will be waiting.</p>
    <p>
    ...
    <p>
      It's the latest--and boldest--move by a major media company to capitalize
      on America's some 6.1 million undergrads. While outlets such asViacom's
      MTVU network and privately owned Zilo Networks have gone after university
      students for years, Palestra's at the front of a new wave led by news
      outlets desperate to connect with young viewers.
    </p>
    <p>
    ...
    <p>
      ...
      gear. And founder Joe Weasel--a former on-air journalist for NBC affiliate
      WCMH-TV in Columbus, Ohio--says he began talking with Fox's local
      affiliates last week about placing Palestra content on their Web sites
      around the country, which could lead to on-air spots.
    </p>
    <p>
    ...
    <p>
      ...
      cable news programs--and to develop stories they value. Palestra's already
      wide reach should help with that, as well as provide Fox a new pipeline
      for talent.
    </p>
    <p>
