...
As a result, the [App component state](https://github.com/abelsj60/jamesabels.net/blob/master/app/App.jsx#L295) is larger than expected so its functionally unrelated child Components (i.e., sibings) can track and participate in animation sequences. A future move to Redux or React Hooks might condense this code.
