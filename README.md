...
This has caused the [component state in App.jsx](https://github.com/abelsj60/jamesabels.net/blob/c53a0c70ec6a084ec9727f4df0301fa825c8e28e/app/App.jsx#L286) to be larger than expected, as functionally unrelated children (i.e., siblings) need to track animation sequences in order to join them. A move to React Hooks or Redux might condense this code.
