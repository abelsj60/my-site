...
As a result, the [App component state](https://github.com/abelsj60/jamesabels.net/blob/master/app/App.jsx#L295) is larger than expected so functionally unrelated sibling Components can track and participate in animation sequences. A move to Redux or React Hooks might tighten this code.
