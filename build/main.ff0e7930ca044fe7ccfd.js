...
function (_Component) {
  ...
  function Home(props) {
    ...
    _this.state = {
      ...
      animate: !_this.props.appState.homeAnimation ? 0 : 2
    };
    _this.handleAnimation = _this.handleAnimation.bind(_assertThisInitialized(_this));
  ...
  _createClass(Home, [{
    key: "handleAnimation",
    value: function handleAnimation(num) {
      this.setState({
        animate: num
      });
    }
    ...
    value: function render() {
      ...
      var homeAnimation = appState.homeAnimation,
          showBusinessCard = appState.showBusinessCard,
          showLegalTerms = appState.showLegalTerms; // const { pinchZoomed } = props.appState;
      ...
      if (!homeAnimation && !this.state.animate // Meaning 0
      && !showBusinessCard && !showLegalTerms) {
        this.timeoutId = setTimeout(function () {
          _this2.handleAnimation(1);

          _this2.timeoutId2 = setTimeout(function () {
            // Can't update state in Render. Must
            // run in the Callback Queue.
            _this2.handleAnimation(2); // timeoutIds reset here (in 2nd timeout), in
    ...
    value: function eventHandlerForMouseDown(num) {
      ...
      return function () {
        if (_this3.state.eventType === 'click') {
        ...
        } else if (_this3.state.eventType === 'touch') {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.appState.showBusinessCard !== prevProps.appState.showBusinessCard || this.props.appState.showLegalTerms !== prevProps.appState.showLegalTerms) {
        if (this.state.animate < 2) {
          [this.timeoutId, this.timeoutId2].forEach(function (id) {
            clearTimeout(id);
          });
          this.timeoutId = 0;
          this.timeoutId2 = 0;
...
var heartbeatKeyframes = Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["keyframes"])(["from{transform:scale(1);transform-origin:center center;animation-timing-function:ease-out;}10%{transform:scale(1.03);animation-timing-function:ease-in;}19%{transform:scale(0.97);animation-timing-function:ease-out;}35%{transform:scale(1.05);animation-timing-function:ease-in;}45%{transform:scale(1);animation-timing-function:ease-out;}"]);
var Container = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "NameTag__Container",
  componentId: "sc-1tuguaa-0"
})(["margin-top:5px;display:", ";animation:", ";animation:", ";pointer-events:", ";flex-direction:column;align-items:center;z-index:2;cursor:pointer;@media (min-height:600px){margin-top:15px;}"], function (p) {
  return p.tempContentIsOn ? 'none' : 'flex';
}, function (p) {
  return p.animate && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(["1.15s ease-in-out ", " 3 both"], heartbeatKeyframes);
}, function (p) {
...
})(["position:absolute;height:100%;width:100%;z-index:1;background-color:midnightblue;opacity:.3;"]);
...
/******/ });
//# sourceMappingURL=main.ff0e7930ca044fe7ccfd.js.map