  ...
  _createClass(App, [{
    ...
    value: function updateHeight() {
      ...
      if (window.pageYOffset > 0 && !this.isAfterTouchWhenScrollingPage) {
        var scrollHandling = new _classes_ScrollHandling_js__WEBPACK_IMPORTED_MODULE_25__["default"](this.state.currentCaller);
...
})(["display:flex;justify-content:center;align-items:center;position:absolute;top:0px;left:0px;bottom:0px;width:100%;background-color:", ";z-index:1;"], Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(["rgba(115,192,232,", ")}"], function (p) {
...
function (_Component) {
  ...
  _createClass(LegalTermsOrBizCard, [{
    ...
    value: function render() {
      ...
      var currentCaller = appState.currentCaller,
          tempContent = appState.tempContent;
      var homeIsActive = currentCaller === 'home'; // REACTIVATE to allow temp content to be closed by clicking the page:
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Container, {
        homeIsActive: homeIsActive // onClick={onClickHandler} // See note, above

      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(CardHolder, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Card // onClick={stopOnClickPropagation} // See note, above
      , {
        tempContent: tempContent
...
/******/ });
//# sourceMappingURL=main.95b617e4c21313197612.js.map