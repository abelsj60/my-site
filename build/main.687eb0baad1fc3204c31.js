...
var Nav = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].nav.withConfig({
  ...
  return p.menu && Object(styled_components__WEBPACK_IMPORTED_MODULE_8__["css"])(["background-color:rgba(175,18,90,.8);position:fixed;top:54px;bottom:0px;width:100%;display:flex;justify-content:center;"]);
});
var NavList = Object(styled_components__WEBPACK_IMPORTED_MODULE_8__["default"])(_primitives_UnorderedList_jsx__WEBPACK_IMPORTED_MODULE_10__["default"]).withConfig({
  ...
  return !p.menu ? Object(styled_components__WEBPACK_IMPORTED_MODULE_8__["css"])(["", " 0px ", " 0px}"], !p.isHome && 'auto', !p.isHome && 'auto') : '';
}, function (p) {
  return p.menu && 'space-evenly';
}, function (p) {
  return p.theme.mediaQueries.narrowBreakTwo;
}, function (p) {
  return p.menu && Object(styled_components__WEBPACK_IMPORTED_MODULE_8__["css"])(["flex-direction:column;margin-bottom:55px;"]);
});
var Icon = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].img.withConfig({
  ...
  return !p.isReverie && !p.showBusinessCard && !p.showLegalTerms && p.illustrationLevel >= 2 && !p.headerMenuIsOpen && Object(styled_components__WEBPACK_IMPORTED_MODULE_8__["css"])(["drop-shadow(", ")"], iconShadow);
}, function (p) {
...
function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var isReverie = currentCaller === 'reverie';
      var isStory = currentCaller == 'chapter';
      var iconType = headerMenuIsOpen ? _public_header_nav_open_png__WEBPACK_IMPORTED_MODULE_2___default.a : _public_header_nav_closed_png__WEBPACK_IMPORTED_MODULE_3___default.a;
...
/******/ });
//# sourceMappingURL=main.687eb0baad1fc3204c31.js.map