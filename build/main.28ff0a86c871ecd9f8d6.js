...
})(["color:white;margin-left:25px;background-color:", ";width:60px;padding:7px;border:1px rgba(255,255,255,.6) solid;user-select:none;"], function (p) {
...
})(["cursor:pointer;margin-right:", ";margin-bottom:0px;color:", ";padding-top:5px;padding-bottom:5px;padding-right:5px;font-weight:400;font-size:", ";user-select:none;"], function (p) {
...
function (_ref) {
  var isHome = _ref.isHome,
      ...
      menu = _ref.menu,
      rest = _objectWithoutProperties(_ref, ["isHome", "isActive", "menu"]);
...
})(["font-size:", ";font-weight:", ";margin-left:", ";color:", ";&&{text-decoration:", ";}@media (min-width:", "){margin-left:", ";font-size:", ";}@media (min-width:0px) and (max-width:", "){font-size:", ";margin-left:", ";}@media (min-width:", ") and (max-width:", "){font-size:", ";margin-left:", ";}"], function (p) {
...
})(["font-weight:", ";flex:1;display:", ";font-style:italic;font-size:", ";margin:1px 10px 0px 13px;min-width:0px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;@media (min-width:", "){font-size:", ";margin-right:0px;}@media (max-width:", "){z-index:", ";}"], fontWeight, function (p) {
  return p.isHome && 'none';
}, function (p) {
...
})(["display:", ";height:22px;margin-left:auto;margin-right:10px;cursor:pointer;padding-top:5px;padding-bottom:5px;padding-left:5px;padding-right:5px;z-index:1;@media (min-width:", "){display:none;}"], function (p) {
  return p.isHome && 'none';
}, function (p) {
...
})(["margin-top:5px;display:", ";animation:", ";pointer-events:", ";flex-direction:column;align-items:center;z-index:2;cursor:pointer;@media (min-height:600px){margin-top:15px;}"], function (p) {
...
})(["font-family:'Aref Ruqaa',serif;text-shadow:1.5px 1.5px 2px rgba(0,0,0,.6);-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;font-size:", ";color:lemonchiffon;font-weight:700;margin-top:-6px;margin-left:16px;@media (min-width:", "){margin-left:10px;font-size:", ";}"], function (p) {
  return p.theme.fontSizes.twelve;
}, function (p) {
  return p.theme.mediaQueries.tinyView;
}, function (p) {
...
})(["overflow:auto;width:80%;display:", ";z-index:2;@media (min-width:338px){width:75%;}@media (min-width:387px){width:70%;}@media (min-width:390px){width:85%;}@media (min-width:", "){width:85%;}@media (min-width:455px){width:75%;}@media (min-width:516px){width:70%;}@media (min-width:553px){width:65%;}p{font-weight:500;margin-bottom:10px;font-size:", ";color:lemonchiffon;text-shadow:1px 1px 2px rgba(0,0,0,.6);text-align:center;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;&:last-child{margin-bottom:0px;}@media (min-width:", "){font-size:", ";}}display:", ";"], function (p) {
...
function NameTag(props) {
  ...
  var tagline = !isCasting || castSpell ? motto : !inCity ? 'Tap the pulses to travel home' : 'Tap the pulses for adventure';
...
/* harmony import */ var _public_dot_full_b_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/dot-full-b.png */ "./public/dot-full-b.png");
/* harmony import */ var _public_dot_full_b_png__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_public_dot_full_b_png__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _public_dot_empty_b_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../public/dot-empty-b.png */ "./public/dot-empty-b.png");
/* harmony import */ var _public_dot_empty_b_png__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_public_dot_empty_b_png__WEBPACK_IMPORTED_MODULE_1__);
...
function ChapterNav(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(Nav, null, react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(StyledList, null, react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_shared_Mapper_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    render: function render(_chapter, idx) {
      ...
      var dotType = chapterIndex === idx ? _public_dot_full_b_png__WEBPACK_IMPORTED_MODULE_0___default.a : _public_dot_empty_b_png__WEBPACK_IMPORTED_MODULE_1___default.a;
      return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(ListItem, {
        key: idx
...
/******/ });
//# sourceMappingURL=main.28ff0a86c871ecd9f8d6.js.map