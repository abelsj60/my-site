...
})(["position:absolute;width:100%;height:52px;top:0px;left:0px;background-color:", ";z-index:-1;@media (max-width:", "){height:", ";background-color:", ";}"], function (p) {
  return !p.hide ? p.theme.colors.darkPink : '';
}, function (p) {
  return p.theme.mediaQueries.narrowBreakTwo;
}, function (p) {
  return !p.isHome && p.menu && '100%';
}, function (p) {
  return !p.isHome && p.menu && p.theme.colors.darkPink;
});
      ...
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(Container, {
        ...
        render: function render(link, idx) {
          ...
          return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(ListItem, {
            ...
            boundHandleClickForApp: boundHandleClickForApp,
            closeHeaderMenu: menuIsOpen && _this2.closeHeaderMenu
          }, link.name));
        }
...
})(["margin:18px 0px 18px ", ";display:flex;flex-direction:column;filter:", ";", ";@media (min-width:", "){margin:25px 0px 25px ", ";}"], function (p) {
...
var Link = function Link(_ref) {
  var to = _ref.to,
      ...
      closeHeaderMenu = _ref.closeHeaderMenu,
      props = _objectWithoutProperties(_ref, ["to", "replace", "boundHandleClickForApp", "callerWillBe", "isCalledByMenu", "closeHeaderMenu"]);
...
/******/ });
//# sourceMappingURL=main.62a9ee80d9cca5fad55f.js.map