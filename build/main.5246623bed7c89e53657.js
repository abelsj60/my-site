...
/* harmony import */ var _classes_Referrer_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./classes/Referrer.js */ "./app/classes/Referrer.js");
...
/* harmony import */ var _temp_content_TooSmallScreen_jsx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./temp-content/TooSmallScreen.jsx */ "./app/temp-content/TooSmallScreen.jsx");
...
function (_Component) {
  ...
  function App(props) {
    ...
    var referrer = new _classes_Referrer_js__WEBPACK_IMPORTED_MODULE_10__["default"](props);
    ...
    react_ga__WEBPACK_IMPORTED_MODULE_4__["default"].initialize('UA-137902767-1');
    react_ga__WEBPACK_IMPORTED_MODULE_4__["default"].pageview(pathname + search); // Tallies initial request
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(styled_components__WEBPACK_IMPORTED_MODULE_2__["ThemeProvider"], {
        theme: {
      ...
      })), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_temp_content_LegalTermsOrBizCard_jsx__WEBPACK_IMPORTED_MODULE_7__["default"], _extends({}, this.props, {
        appState: this.state,
        boundHandleClickForApp: boundHandleClickForApp
      })), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_header_footer_Footer_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], _extends({}, this.props, {
        appState: this.state,
        boundHandleClickForApp: boundHandleClickForApp
    ...
    value: function updateHeight() {
      ...
      var newHeight = react_device_detect__WEBPACK_IMPORTED_MODULE_6__["isMobile"] && (!react_device_detect__WEBPACK_IMPORTED_MODULE_6__["isMobileSafari"] || this.state.isAfterTouch || this.state.tooNarrow && this.state.pinchZoomed) ? document.documentElement.clientHeight : window.innerHeight; // When zoomed, always resize when screen isn't too narrow.
      ...
      if (this.state.pinchZoomed && !this.state.tooNarrow) {
      ...
      if (window.pageYOffset > 0) {
        var scrollHandling = new _classes_ScrollHandling_js__WEBPACK_IMPORTED_MODULE_11__["default"](location);
      ...
      this.setState(function () {
        return {
          height: newHeight,
          tooNarrow: newHeight < 350 ? true : false,
          isAfterTouch: _this3.state.isAfterTouch && false
        };
      });
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      var location = new _classes_Location_js__WEBPACK_IMPORTED_MODULE_8__["default"]('/', this.props, prevProps);
      ...
      if (location.justChanged) {
        ...
        var referrer = new _classes_Referrer_js__WEBPACK_IMPORTED_MODULE_10__["default"](prevProps);
        var hcForApp = new _classes_ClickHandling_js__WEBPACK_IMPORTED_MODULE_1__["default"]('app', this);
        ...
        && window.location.pathname !== '/i') {
          ...
          react_ga__WEBPACK_IMPORTED_MODULE_4__["default"].pageview(pathname + search);
        }
      }
    }
  }]);
...
})(["font-size:", ";color:", ";font-weight:400;@media (min-width:", "){font-size:", ";}Shelf"], function (p) {
...
})(["overflow:auto;p{&:last-child{margin-bottom:0px;}}img{margin-top:0px;}ul,ol{margin-top:0px;margin-bottom:", ";}li{margin-bottom:10px;&:last-child{margin-bottom:0px;}}"], function (p) {
  return p.theme.bottomMargin.regular;
});
...
/* harmony import */ var _projects_MultiProjectNav_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../projects/MultiProjectNav.jsx */ "./app/projects/MultiProjectNav.jsx");
  ...
  _createClass(ComponentData, [{
    ...
    value: function getSection(props, ref, params) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(Section, _extends({}, props, {
        data: contentData // Only valid if '/chapter',
    ...
    value: function getMenuContent(props, params) {
      ...
      switch (type) {
        ...
        case 'projects':
          MenuContent = _projects_MultiProjectNav_jsx__WEBPACK_IMPORTED_MODULE_3__["default"];
          break;
...
module.exports = {"attributes":{"page":"home","type":"long-description","updated":"11-23-18"},"body":"\nI'm a Web developer and former start-up founder. I used to write about technology, digital media, and M&A as a staff reporter for Forbes.com and Mergermarket. Now I write code for consumer technology projects with creative narratives.","frontmatter":"page: home\ntype: long-description\nupdated: 11-23-18"}
...
var map = {
	...
	"./04-13-2019-when-styles-break.md": "./app/data/reveries/04-13-2019-when-styles-break.md",
	"./04-17-19-virtual-reality-is-light-on-reality-one.md": "./app/data/reveries/04-17-19-virtual-reality-is-light-on-reality-one.md",
	"./04-18-19-virtual-reality-is-light-on-reality-two.md": "./app/data/reveries/04-18-19-virtual-reality-is-light-on-reality-two.md"
};
...
/***/ "./app/data/reveries/04-13-2019-when-styles-break.md":
/*!***********************************************************!*\
  !*** ./app/data/reveries/04-13-2019-when-styles-break.md ***!
  \***********************************************************/
/*! no static exports found */
...
})(["color:white;margin-left:25px;background-color:", ";width:43px;padding:7px;"], function (p) {
...
var RestyledLink = Object(styled_components__WEBPACK_IMPORTED_MODULE_7__["default"])( // Filter out home from StyledLink
...
var NameAsLink = Object(styled_components__WEBPACK_IMPORTED_MODULE_7__["default"])( // Filter out hide from RestyledLink
// eslint-disable-next-line
function (_ref2) {
  var hide = _ref2.hide,
      rest = _objectWithoutProperties(_ref2, ["hide"]);

  return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(RestyledLink, rest);
}).withConfig({
  displayName: "Header__NameAsLink",
  componentId: "sc-1rxr5md-3"
})(["display:", ";font-size:", ";"], function (p) {
  return p.hide && 'none';
}, function (p) {
...
var Nav = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].nav.withConfig({
...
})(["display:", ";margin-top:-2px;padding:", ";background-color:", ";border-radius:", ";", ";@media (min-width:", "){display:block;margin-right:", ";}"], function (p) {
  ...
  return p.menu && Object(styled_components__WEBPACK_IMPORTED_MODULE_7__["css"])(["flex:1;display:block;@media (min-width:", "){margin-left:37px;}"], p.theme.mediaQueries.tinyView);
}, function (p) {
...
function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var isReverie = currentCaller === 'reverie';
      var iconType = menuIsOpen ? _public_header_nav_open_png__WEBPACK_IMPORTED_MODULE_1___default.a : _public_header_nav_closed_png__WEBPACK_IMPORTED_MODULE_2___default.a;
...
})(["justify-content:flex-start;align-items:center;overflow:hidden;flex-direction:column;"]);
...
var BoyInForeground = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "Home__BoyInForeground",
  componentId: "navei3-7"
})(["position:absolute;display:block;background-image:url(", ");background-size:cover;background-position:center;background-repeat:no-repeat;width:100%;height:100%;pointer-events:none;z-index:2;"], function (p) {
  return p.srcImage;
});
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2__["Fragment"], null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(RestyledMain, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_shared_Parallax_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    render: function render(renderProps) {
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(BioBox, {
        ...
        "data-friction-x": ".7",
        "data-friction-y": ".7"
      }, react_html_parser__WEBPACK_IMPORTED_MODULE_5___default()(marked__WEBPACK_IMPORTED_MODULE_6___default()(_data_about_home_page_about_md__WEBPACK_IMPORTED_MODULE_4___default.a.body, {
        smartypants: true
      }))));
    }
...
var RestyledList = Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_primitives_UnorderedList_jsx__WEBPACK_IMPORTED_MODULE_4__["default"]).withConfig({
  ...
  return p.menu && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(["display:block;margin-right:0;"]);
});
...
})(["font-size:", ";color:", ";margin-bottom:13px;font-weight:400;@media (min-width:", "){font-size:", ";}"], function (p) {
  return p.theme.fontSizes.six;
}, function (p) {
...
function DesktopProjectNav(props) {
  var appState = props.appState,
      bodyState = props.bodyState,
      data = props.data;
  var isMenu = appState.isMenu; // Must use bodyState because the '/menu' url doesn't
  // have the project and thumbnail number in it

  var indexForProjectData = bodyState.indexForProjectData;
  var finalData = data;
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(RestyledList, {
    menu: isMenu
  }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_shared_Mapper_jsx__WEBPACK_IMPORTED_MODULE_0__["default"], {
    ...
    render: function render(project, idx) {
      ...
      var lastGroup = idx === finalData.length - 1;
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("li", {
        key: idx
...
var Group = Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_primitives_UnorderedList_jsx__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  ...
  return p.isProjectPage && '1';
}, function (p) {
  return p.isProjectPage && 'flex-end';
}, function (p) {
  return p.isProjectPage && '25px';
}, react_device_detect__WEBPACK_IMPORTED_MODULE_6__["isIE"] && 'flex-shrink: 0;', function (p) {
  return p.menu && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(["margin-bottom:", ";max-width:100%;"], !p.lastGroup && '30px');
});
var ListItem = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].li.withConfig({
  ...
  return !p.lastItem && '15px';
}, function (p) {
  return react_device_detect__WEBPACK_IMPORTED_MODULE_6__["isIE"] && p.lastItem && 'flex-shrink: 1.0275;';
}, function (p) {
  return !p.isProjectPage && '0px';
}, function (p) {
  return p.theme.mediaQueries.narrowBreakOne;
}, function (p) {
  return !p.lastItem && !p.isProjectPage && '20px';
});
var RestyledLink = Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])( // Filter out highlightThis, isProjectPage from StyledLink
// eslint-disable-next-line
function (_ref) {
  var highlightThis = _ref.highlightThis,
      isProjectPage = _ref.isProjectPage,
      rest = _objectWithoutProperties(_ref, ["highlightThis", "isProjectPage"]);
...
function ProjectNav(props) {
  var activeGroup = props.activeGroup,
      ...
      bodyState = props.bodyState,
      lastGroup = props.lastGroup,
      project = props.project;
  var _project$attributes = project.attributes,
      projectName = _project$attributes.projectName,
      projectThumbnail = _project$attributes.projectThumbnail;
  var indexForProjectPics = bodyState.indexForProjectPics;
  var isProjectPage = activeGroup === undefined;
  var isMenu = appState.isMenu;
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Group, {
    ...
    render: function render(thumb, idx) {
      ...
      var lastItem = idx === projectThumbnail.length - 1;
      var highlightThis = isProjectPage && indexForProjectPics === idx || activeGroup && indexForProjectPics === idx;
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(ListItem, {
        ...
        isProjectPage: isProjectPage,
        to: "/projects/".concat(Object(_helpers_normalize_js__WEBPACK_IMPORTED_MODULE_1__["default"])(projectName), "/").concat(thumbnailNumber)
...
/* harmony import */ var react_device_detect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-device-detect */ "./node_modules/react-device-detect/dist/index.js");
...
})(["display:flex;flex-direction:column;flex-shrink:0;margin:0px;padding-top:15px;border-top:1px solid ", ";"], function (p) {
...
})(["display:flex;margin-bottom:10px;font-size:", ";line-height:1.5;color:", ";"], function (p) {
  return p.theme.fontSizes.seven;
}, function (p) {
  return p.theme.colors.lightBlack;
});
var ImageHolder = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  displayName: "Projects__ImageHolder",
  componentId: "e6bzkp-6"
})(["padding:17px;background-color:", ";"], function (p) {
...
})(["width:100%;height:100%;max-width:100%;box-sizing:border-box;", "  vertical-align:top;box-shadow:2px 4px 12px rgba(0,0,0,.3);"], !react_device_detect__WEBPACK_IMPORTED_MODULE_0__["isIE"] && 'flex: 1;');
function Projects(props) {
  ...
  var _project$attributes = project.attributes,
      ...
      projectName = _project$attributes.projectName,
      showTheseAttributes = _project$attributes.showTheseAttributes,
      type = _project$attributes.type;
  ...
  return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_primitives_Main_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_primitives_ContentHolder_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_shared_Shelf_jsx__WEBPACK_IMPORTED_MODULE_8__["default"], {
    height: "32px",
    tinyHeight: "20px"
  }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_shared_MenuButton_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], props), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_ProjectNav_jsx__WEBPACK_IMPORTED_MODULE_6__["default"], _extends({}, props, {
    project: project // attributes
...
function (_Component) {
  ...
  function ContentLoader(props) {
    ...
    _this.overflowRef = location.type === 'chapter' ? react__WEBPACK_IMPORTED_MODULE_3___default.a.createRef() : '';
    _this.state = {
  ...
  _createClass(ContentLoader, [{
    ...
    value: function render() {
      ...
      if (!needsRedirect && !isNotFound) {
        ...
        componentData = new _classes_ComponentData_js__WEBPACK_IMPORTED_MODULE_0__["default"](referrer.location);
      ...
      return needsRedirect ? react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react_router__WEBPACK_IMPORTED_MODULE_5__["Redirect"], {
        ...
        render: function render() {
          return componentData.getSection(_this2.props, location.type === 'chapter' ? _this2.overflowRef : undefined, location.params);
        }
      }));
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (location.needsRedirect) {
        ...
        state.rebuild(this.props.boundHandleClickForBody); // The scrollTop reset is not currently applied to
...
var Link = function Link(_ref) {
  ...
  var isMenu = pathname.includes('menu') && pathname.split('/')[2] === 'menu';
  var sameLocation = !isMenu && window.location.pathname.includes(to);
...
function (_Component) {
  ...
  _createClass(ParallaxComponent, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.parallax = new parallax_js__WEBPACK_IMPORTED_MODULE_1___default.a(this.scene);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
...
})(["height:", ";display:flex;flex-shrink:0;margin-right:25px;margin-bottom:24px;@media (min-width:", "){height:", ";}"], function (p) {
...
})(["margin:-4px 0px 0px -15px;max-width:150px;display:flex;flex-shrink:0;position:relative;"]);
...
})(["width:150px;height:25px;display:flex;flex:1;"]);
...
function ChapterNav(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(Nav, null, react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(StyledList, null, react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_shared_Mapper_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    render: function render(_chapter, idx) {
      ...
      var dot = indexForChapterData === idx ? _public_dot_full_png__WEBPACK_IMPORTED_MODULE_0___default.a : _public_dot_empty_png__WEBPACK_IMPORTED_MODULE_1___default.a;
...
})(["display:", ";flex:1;overflow:hidden;"], function (p) {
  return p.text !== 'hidden' ? 'none' : 'flex';
});
...
})(["position:absolute;top:0px;left:0px;background-image:url(", ");background-position:center;background-size:cover;height:100%;width:100%;"], function (p) {
  return p.src;
});
...
function Story(props) {
  ...
  var textStatus = !showStoryText ? 'hidden' : '';
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_primitives_Main_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], null, react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(RestyledContentHolder, {
    text: textStatus
  }, react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_shared_Shelf_jsx__WEBPACK_IMPORTED_MODULE_7__["default"], {
    height: "19px"
...
var OuterContainer = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].section.withConfig({
  displayName: "LegalTermsOrBizCard__OuterContainer",
  ...
  return p.home && Object(styled_components__WEBPACK_IMPORTED_MODULE_5__["css"])(["background-color:", ""], !p.copying ? 'rgba(115,192,232, 0.35)' : 'rgba(255,231,76, 0.25)');
});
var CenteringContainer = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].div.withConfig({
  displayName: "LegalTermsOrBizCard__CenteringContainer",
...
var CardHolder = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].div.withConfig({
  displayName: "LegalTermsOrBizCard__CardHolder",
  componentId: "sc-171ayyj-2"
})(["display:flex;justifyContent:center;"]);
var InnerContainer = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].div.withConfig({
  displayName: "LegalTermsOrBizCard__InnerContainer",
  componentId: "sc-171ayyj-3"
})([""]);
var Card = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].section.withConfig({
...
var CardContentArea = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].div.withConfig({
...
var StyledClipboardButton = Object(styled_components__WEBPACK_IMPORTED_MODULE_5__["default"])(react_clipboard_js__WEBPACK_IMPORTED_MODULE_0___default.a).withConfig({
...
var MyCopyright = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].span.withConfig({
...
var ClipCopyright = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].span.withConfig({
  displayName: "LegalTermsOrBizCard__ClipCopyright",
  componentId: "sc-171ayyj-9"
...
function (_Component) {
  ...
  _createClass(LegalTermsOrBizCard, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(OuterContainer, {
        home: homeIsActive,
      ...
      }, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(CenteringContainer, null, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(CardHolder, null, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_shared_Parallax_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
        render: function render(renderProps) {
    ...
    value: function componentDidMount() {
      ...
      if (showBusinessCard) {
        react_ga__WEBPACK_IMPORTED_MODULE_4__["default"].pageview("".concat(pathname, "businesscard"));
      } else if (showLegalTerms) {
        react_ga__WEBPACK_IMPORTED_MODULE_4__["default"].pageview("".concat(pathname, "legalterms"));
      }
    }
  }, {
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      ...
      if (showBusinessCard && !businessCardWasActive) {
        react_ga__WEBPACK_IMPORTED_MODULE_4__["default"].modalview("".concat(pathname, "businesscard"));
      } else if (showLegalTerms && !legalTermsWereActive) {
        react_ga__WEBPACK_IMPORTED_MODULE_4__["default"].modalview("".concat(pathname, "legalterms"));
      }
...
/***/ "./app/temp-content/TooSmallScreen.jsx":
/*!*********************************************!*\
  !*** ./app/temp-content/TooSmallScreen.jsx ***!
  \*********************************************/
/*! exports provided: default */
...
var FullPage = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "TooSmallScreen__FullPage",
  componentId: "ehrmt6-0"
})(["display:flex;align-items:center;background-color:", ";position:absolute;height:100%;width:100%;z-index:2;"], function (p) {
  return p.theme.colors.pink;
});
var Text = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].p.withConfig({
  displayName: "TooSmallScreen__Text",
  componentId: "ehrmt6-1"
})(["margin-left:25px;margin-right:25px;color:", ";font-size:", ";"], function (p) {
  return p.theme.colors.yellow;
}, function (p) {
  return p.theme.fontSizes.sixteen;
...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  var _window$location = window.location,
      pathname = _window$location.pathname,
      search = _window$location.search;
  var tooNarrow = props.tooNarrow;

  if (!react_device_detect__WEBPACK_IMPORTED_MODULE_3__["isMobile"] || !tooNarrow) {
    return null;
  }
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FullPage, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Text, null, "Uh-oh. It's a little narrow in here. Try rotating your screen..."));
});
