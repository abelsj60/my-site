...
})(["font-family:'Aref Ruqaa',serif;text-shadow:1.5px 1.5px 2px rgba(0,0,0,.6);-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;font-size:", ";color:", ";font-weight:700;margin-top:-6px;margin-left:16px;@media (min-width:", "){margin-left:18px;font-size:", ";}"], function (p) {
  return p.theme.fontSizes.twelve;
}, function (p) {
...
/******/ });
//# sourceMappingURL=main.d95834b6362ac41282e1.js.map