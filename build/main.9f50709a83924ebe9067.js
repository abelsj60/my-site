...
/* harmony import */ var _urlPrefix__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./urlPrefix */ "./app/helpers/urlPrefix.js");
...
function preloadBigImages() {
  ...
  _data_the_story_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].forEach(function (chapter) {
    ...
    var illSource = "".concat(_urlPrefix__WEBPACK_IMPORTED_MODULE_2__["default"], "/chapter-").concat(number, "/chapter-").concat(number, "-imc-main-101419-q").concat(imageWidth < 2880 ? '90' : '50', "-").concat(imageWidth, ".jpg");
    var blurredSource = "".concat(_urlPrefix__WEBPACK_IMPORTED_MODULE_2__["default"], "/chapter-").concat(number, "/blurred/chapter-").concat(number, "-ink-blur-0x15-160.jpg");
  ...
  _data_home_home_md__WEBPACK_IMPORTED_MODULE_0___default.a.attributes.preloadUrls.forEach(function (path, idx) {
    ...
    if (path.includes('boy') && !path.includes('blur') && imageWidth >= 2880 && imageWidth <= 3000) {
      ...
      source = "".concat(_urlPrefix__WEBPACK_IMPORTED_MODULE_2__["default"], "/").concat(path, "/").concat(filePrefix, "-imc-main-101419-3000.png");
    } else {
      if (path.includes('blur')) {
        source = "".concat(_urlPrefix__WEBPACK_IMPORTED_MODULE_2__["default"], "/").concat(path, "/").concat(filePrefix, "-ink-blur-0x15-160.").concat(path.includes('boy') ? 'png' : 'jpg');
      } else {
        source = "".concat(_urlPrefix__WEBPACK_IMPORTED_MODULE_2__["default"], "/").concat(path, "/").concat(filePrefix, "-imc-main-101419-").concat(!path.includes('boy') ? imageWidth < 2880 ? 'q90-' : 'q50-' : '').concat(imageWidth, ".").concat(path.includes('boy') ? 'png' : 'jpg');
      }
    }
  ...
  ["".concat(_urlPrefix__WEBPACK_IMPORTED_MODULE_2__["default"], "/business-card/teen-fairy-img-q90-640-4x.jpg"), "".concat(_urlPrefix__WEBPACK_IMPORTED_MODULE_2__["default"], "/not-found/jinni-img-q90-1240-4x.jpg")].forEach(function (src, idx) {
    var image = new Image();
    image.src = src;
...
/******/ });
//# sourceMappingURL=main.9f50709a83924ebe9067.js.map