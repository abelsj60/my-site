...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var location = new _classes_Location_js__WEBPACK_IMPORTED_MODULE_8__["default"]('/', this.props, prevProps); // Ensure window top's at zero after orientation change
...
var map = {
	...
	"./04-17-19-when-stympy-elements-stump-one.md": "./app/data/reveries/04-17-19-when-stympy-elements-stump-one.md",
	"./04-18-19-when-stumpy-elements-stump-two.md": "./app/data/reveries/04-18-19-when-stumpy-elements-stump-two.md"
};
...
/***/ "./app/data/reveries/04-17-19-when-stympy-elements-stump-one.md":
/*!**********************************************************************!*\
  !*** ./app/data/reveries/04-17-19-when-stympy-elements-stump-one.md ***!
  \**********************************************************************/
/*! no static exports found */
...
var Container = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].header.withConfig({
  ...
  return p.home === 'active' ? 'center' : undefined;
});
...
var RestyledLink = Object(styled_components__WEBPACK_IMPORTED_MODULE_7__["default"])(_primitives_StyledLink_jsx__WEBPACK_IMPORTED_MODULE_8__["default"]).withConfig({
  ...
  return p.home !== 'active' ? p.theme.fontSizes.six : p.theme.fontSizes.three;
});
...
var Nav = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].nav.withConfig({
  ...
  return p.home === 'active' ? undefined : 'none';
}, function (p) {
  return p.home === 'active' ? '8px 15px' : undefined;
}, function (p) {
  return p.home === 'active' ? 'rgba(0,0,0,0.25)' : undefined;
}, function (p) {
  return p.home === 'active' ? '10px' : undefined;
}, function (p) {
  ...
  return p.home !== 'active' ? '15px' : undefined;
});
...
function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var homeIsActive = currentCaller === 'home' ? 'active' : '';
      ...
      var hideBackground = homeIsActive.length > 0 || !showStoryText && !reverieIsActive;
      var hideNameAndMotto = menuIsOpen || homeIsActive.length > 0 ? 'active' : '';
      ...
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(Container, {
        ...
        render: function render(link, idx) {
          var pathIsActive = link.path.includes(referrer.location) ? 'active' : '';
...
/* harmony import */ var _primitives_StyledLink_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../primitives/StyledLink.jsx */ "./app/primitives/StyledLink.jsx");
/* harmony import */ var _primitives_UnorderedList_jsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../primitives/UnorderedList.jsx */ "./app/primitives/UnorderedList.jsx");
/* harmony import */ var react_device_detect__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-device-detect */ "./node_modules/react-device-detect/dist/index.js");
...
})(["max-width:150px;display:flex;", "  ", ";"], react_device_detect__WEBPACK_IMPORTED_MODULE_5__["isIE"] && 'flex-shrink: 0;', function (p) {
  return p.menu && Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["css"])(["margin-bottom:", ";max-width:100%;"], !p.lastGroup ? '30px' : undefined);
});
var ListItem = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].li.withConfig({
  ...
  return !p.lastItem ? '20px' : undefined;
}, function (p) {
  return react_device_detect__WEBPACK_IMPORTED_MODULE_5__["isIE"] && p.lastItem ? 'flex-shrink: 1.0275;' : '';
}, function (p) {
...
})(["border:1px solid #b9dff3;display:block;position:relative;"]);
...
})(["width:100%;max-width:100%;vertical-align:top;align-self:center;"]);
...
})(["width:100%;height:", ";left:0px;bottom:0px;position:absolute;background-color:", ";"], function (p) {
  return p.isProjectPage ? '100%' : '4px';
}, function (p) {
  return p.isProjectPage ? 'rgba(115,192,232,0.2)' : p.theme.colors.yellow;
});
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Group, {
    ...
    render: function render(thumb, idx) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ListItem, {
        ...
        src: thumb
      }), highlightThis && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Highlighter, {
        isProjectPage: isProjectPage
      })));
    }
  }));
...
/* harmony import */ var _ProjectNav_jsx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ProjectNav.jsx */ "./app/projects/ProjectNav.jsx");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_6__);
...
var ProjectName = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].h1.withConfig({
...
var Shelf = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "Projects__Shelf",
  componentId: "e6bzkp-1"
})(["display:flex;flex-shrink:0;margin-right:25px;margin-bottom:15px;justify-content:space-between;"]);
var Hed = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].h3.withConfig({
...
var Graf = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].p.withConfig({
...
var Figure = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].figure.withConfig({
  displayName: "Projects__Figure",
  componentId: "e6bzkp-5"
})(["display:flex;flex-direction:column;margin:0px;flex-shrink:0;"]);
var Caption = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].figcaption.withConfig({
...
var ImageHolder = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
...
})(["width:100%;height:100%;max-width:100%;border:2px solid #b9dff3;box-sizing:border-box;", "  vertical-align:top;"], !react_device_detect__WEBPACK_IMPORTED_MODULE_0__["isIE"] && 'flex: 1;');
function Projects(props) {
  ...
  var keys = showTheseAttributes.map(function (name) {
    return name;
  });
  var attributeArray = keys.map(function (name) {
    return project.attributes[name];
  });
  return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_primitives_Main_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], null, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_primitives_ContentHolder_jsx__WEBPACK_IMPORTED_MODULE_7__["default"], null, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Shelf, null, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_shared_MenuButton_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], props), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_ProjectNav_jsx__WEBPACK_IMPORTED_MODULE_5__["default"], _extends({}, props, {
    project: project // attributes

  }))), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_primitives_Overflow_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], null, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(ProjectName, null, projectName), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Dek, null, type), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_shared_Mapper_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    render: function render(text, idx) {
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_6__["Fragment"], {
        key: idx
      }, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Hed, null, keys[idx][0].toUpperCase() + keys[idx].slice(1)), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Graf, null, text));
    }
  }), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Figure, null, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Hed, null, "Featured image"), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Graf, null, caption), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(ImageHolder, null, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Image, {
    alt: "mainPic",
    src: source
  }))))));
}
...
var PictureHolder = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].section.withConfig({
...
/******/ });
//# sourceMappingURL=main.4aa8c8f7352b5a4dd603.js.map