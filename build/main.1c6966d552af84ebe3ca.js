...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function handlePasswordSubmit(event) {
      ...
      if (this.state.password === 'enter' || this.state.password === 'Enter') {
        this.setState({
          isValidUser: true
        });
      } else {
    ...
    value: function updateHeight() {
      ...
      if (newHeight === this.state.height || this.minAllowedHeight > newHeight) {
        react_ga__WEBPACK_IMPORTED_MODULE_4__["default"].event({
          category: 'App state',
          action: "\n          Resized w/o changing height. Current: ".concat(this.state.height, ", new ").concat(newHeight, "\n        "),
          value: newHeight,
          label: "Page: ".concat(pathname).concat(search)
        });
        return false;
...
})(["overflow:auto;p{margin-bottom:", ";margin-left:2px;&:last-child{margin-bottom:0px;}}"], function (p) {
  return p.theme.bottomMargin.regular;
});
        ...
        if (!isActive || isActive && abracadabra) {
          ...
          if (isActive && abracadabra) {
            ...
            react_ga__WEBPACK_IMPORTED_MODULE_1__["default"].event({
              ...
              label: "The score was ".concat(score, ".")
            });
  ...
  _createClass(ScrollHandling, [{
        ...
        if (overflowRef.current.scrollTop !== 0) {
          ...
          if (updateScrollTop) {
            react_ga__WEBPACK_IMPORTED_MODULE_0__["default"].event({
              ...
              action: "Reset top for ".concat(this._caller),
    ...
    value: function resetWindowTop() {
      ...
      if (window.pageYOffset > 0) {
        react_ga__WEBPACK_IMPORTED_MODULE_0__["default"].event({
          category: 'Scroll management',
          action: "Reset window for ".concat(this._caller),
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(Container, {
        ...
        hide: hideNameAndMotto
      }, "Amazing stories through code"), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(Nav, {
        isHome: isHome,
        menu: menuIsOpen
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var location = new _classes_Location_js__WEBPACK_IMPORTED_MODULE_3__["default"]('/', this.props, prevProps); // Don't automatically close menu if
...
})(["font-family:'Aref Ruqaa',serif;text-shadow:1.5px 1.5px 2px rgba(0,0,0,.6);-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;font-size:", ";color:", ";font-weight:700;margin-top:-6px;margin-left:16px;@media (min-width:", "){margin-left:22px;font-size:", ";}"], function (p) {
  return p.theme.fontSizes.twelve;
}, function (p) {
...
function NameTag(props) {
  ...
  var eventHandler = function eventHandler(event) {
    ...
    react_ga__WEBPACK_IMPORTED_MODULE_5__["default"].event({
      category: 'Home state',
...
function PictureBox(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PictureHolder, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(BoyInForeground, {
    srcImage: _data_home_home_md__WEBPACK_IMPORTED_MODULE_0___default.a.attributes.boyInForegroundImage
    ...
    isCasting: isCasting,
    castSpell: castSpell,
    srcImage: _data_home_home_md__WEBPACK_IMPORTED_MODULE_0___default.a.attributes.fantasyImage,
    ...
    isCasting: isCasting,
    castSpell: castSpell,
    srcImage: _data_home_home_md__WEBPACK_IMPORTED_MODULE_0___default.a.attributes.cityImage
  }));
}
...
})(["margin:25px 0px 25px ", ";display:flex;flex-direction:column;filter:", ";", ";"], function (p) {
...
function DesktopProjectNav(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(RestyledList, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_shared_Mapper_jsx__WEBPACK_IMPORTED_MODULE_0__["default"], {
    ...
    render: function render(mappedProject, idx) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("li", {
        key: idx
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Graf, null, "".concat(projectName, " | ").concat(type)), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_ProjectNav_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], _extends({}, props, {
...
})(["font-size:", ";margin-bottom:", ";margin-left:2px;font-weight:300;color:", ";"], function (p) {
  ...
  _createClass(ErrorBoundary, [{
    ...
    value: function componentDidCatch(error, errorInfo) {
      ...
      react_ga__WEBPACK_IMPORTED_MODULE_1__["default"].exception({
        description: "".concat(error, ". Initial load: ").concat(initialLoad, ". Info: ").concat(JSON.stringify(errorInfo), ".")
      });
    }
  }, {
    key: "componentDidMount",
...
})(["position:absolute;top:0px;bottom:0px;left:0px;right:0px;display:flex;justify-content:center;align-items:center;background-color:#fd1172;"]);
...
function PasswordLogin(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FormHolder, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Feedback, null, props.appState.wrongPassword), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Form, {
    action: "",
...
})(["margin:-4px 0px 0px -13px;max-width:150px;display:flex;flex-shrink:0;position:relative;"]);
...
function (_Component) {
  ...
  _createClass(LegalTermsOrBizCard, [{
    ...
    value: function componentDidMount() {
      ...
      var pathname = window.location.pathname;
      react_ga__WEBPACK_IMPORTED_MODULE_3__["default"].modalview("".concat(pathname).concat(showBusinessCard ? 'businesscard' : 'legalterms'));
    }
  }, {
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      ...
      if (showBusinessCard && !businessCardWasActive) {
        react_ga__WEBPACK_IMPORTED_MODULE_3__["default"].modalview("".concat(pathname, "businesscard"));
      } else if (showLegalTerms && !legalTermsWereActive) {
        react_ga__WEBPACK_IMPORTED_MODULE_3__["default"].modalview("".concat(pathname, "legalterms"));
      }
...
/******/ });
//# sourceMappingURL=main.1c6966d552af84ebe3ca.js.map