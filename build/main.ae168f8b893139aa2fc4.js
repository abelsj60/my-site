    ...
    value: function render() {
      ...
      return  false ? undefined : react__WEBPACK_IMPORTED_MODULE_22___default.a.createElement(styled_components__WEBPACK_IMPORTED_MODULE_12__["ThemeProvider"], {
        theme: {
          ...
          blurForHeaderMenu: this.state.headerMenuIsOpen // Consolidate w/temp content?
...
function prelodBigImages() {
  var images = {};
  images.alreadyLoaded = []; // For height
  ...
  var imageWidth = [960, 1024, 1080, 1136, 1200, 1280, 1334, 1440, 1536, 1600, 1792, 1921, 2048, 2160, 2304, 2436, 2560, 2688, 2736, 2880, 3000, 3840, 4096, 5120, 7680].find(function (imgWidth, idx, arr) {
    if (idx < arr.length - 1) {
  ...
  _data_the_story_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].forEach(function (chapter) {
    ...
    images["chapter-".concat(chapter.attributes.number, "-blurred")] = imageB; // const newSource = `chapter-${chapter.attributes.number}-imc-main-${imageWidth}.jpg`;
  });
...
var RestyledContentHolder = Object(styled_components__WEBPACK_IMPORTED_MODULE_9__["default"])(_primitives_ContentHolder_jsx__WEBPACK_IMPORTED_MODULE_7__["default"]).withConfig({
  ...
  return !p.headerMenuIsOpen && (p.illustrationDirection === 'exit' && p.illustrationLevel < 2 || p.illustrationDirection === 'enter' && p.illustrationLevel < 1) ? '1' : '0';
}, function (p) {
  return p.illustrationLevel > 0 && p.illustrationLevel < 3 && 'opacity .35s';
}, function (p) {
...
var BlurredFallback = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].img.withConfig({
  ...
  return p.imageLoaded < 1 || p.illustrationLevel >= 2 && p.tempContent < 1 && !p.headerMenuIsOpen ? '1' : '0';
}, function (p) {
...
var BlurredImage = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].img.withConfig({
  ...
  return p.imageLoaded < 1 || p.tempContent < 1 && !p.headerMenuIsOpen && (p.illustrationDirection === 'exit' && p.illustrationLevel > 2 || p.illustrationDirection === 'enter' && p.illustrationLevel >= 2) ? '0' : '1';
}, function (p) {
...
/******/ });
//# sourceMappingURL=main.ae168f8b893139aa2fc4.js.map