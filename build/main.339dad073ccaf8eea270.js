...
/* harmony import */ var react_resize_detector__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! react-resize-detector */ "./node_modules/react-resize-detector/lib/esm/index.js");
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function updateHeight() {
      ...
      if (!react_device_detect__WEBPACK_IMPORTED_MODULE_15__["isMobile"] && this.state.width !== window.innerWidth && this.state.height === window.innerHeight) {
        return false;
      ...
      var newHeight = react_device_detect__WEBPACK_IMPORTED_MODULE_15__["isMobile"] && (!react_device_detect__WEBPACK_IMPORTED_MODULE_15__["isMobileSafari"] || this.state.isAfterTouch) ? document.documentElement.clientHeight : window.innerHeight; // console.log('newHeight:', newHeight);
      ...
      this.setState(function () {
        return {
          ...
          isAfterTouch: _this4.state.isAfterTouch && false // True until handleMove says otherwise.
...
/******/ });
//# sourceMappingURL=main.339dad073ccaf8eea270.js.map