...
})(["display:", ";margin-left:25px;width:69px;padding:7px 0px;text-align:center;cursor:pointer;position:relative;background-color:unset;border:1px rgba(255,255,255,.6) solid;box-shadow:", ";transition:", ";user-select:none;:focus{outline:0;}"], function (p) {
  return !p.isStory ? 'none' : '';
}, function (p) {
  return p.boxShadow && '2px 2px 2.5px rgba(0, 0, 0, .4)';
}, function (p) {
  return p.animateImageBlur && 'box-shadow .15s';
});
...
function Button(props) {
  var animateImageBlur = props.animateImageBlur,
      boxShadow = props.boxShadow,
      className = props.className,
      clickFunction = props.clickFunction,
      isStory = props.isStory,
      showStoryText = props.showStoryText,
      text = props.text;
...
var Line = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  ...
  return p.animateImageBlur && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(["opacity ", ""], p.showStoryText ? '.35s' : '.15s');
}, function (p) {
...
function FooterContainer(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Container, {
    ...
    animateImageBlur: animateImageBlur
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_Button_jsx__WEBPACK_IMPORTED_MODULE_0__["default"], {
    showStoryText: showStoryText,
...
var HeaderBackground = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].div.withConfig({
  ...
  return p.animateImageBlur && Object(styled_components__WEBPACK_IMPORTED_MODULE_7__["css"])(["opacity ", ""], p.showStoryText ? '.35s' : '.15s');
}, function (p) {
...
var RestyledContentHolder = Object(styled_components__WEBPACK_IMPORTED_MODULE_8__["default"])(_primitives_ContentHolder_jsx__WEBPACK_IMPORTED_MODULE_6__["default"]).withConfig({
  ...
  return p.showStoryText ? '.35s' : '.15s';
}, function (p) {
...
/******/ });
//# sourceMappingURL=main.c0a5a1b69d0024678c3a.js.map